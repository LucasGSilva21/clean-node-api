import { SaveSurveyResultRepository, SurveyResultModel, LoadSurveyResultRepository } from '@/data/usecases/survey-result/save-survey-result/db-save-survey-result-protocols'
